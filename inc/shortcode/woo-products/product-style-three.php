...
class WPBakeryShortcode_pakghor_product_three extends WPBakeryShortcode {
	protected function content( $atts, $content = null ) {
		...
		ob_start();
			...
			pakghor_product_three( $section_top_icon, $section_top_image, $section_top_image_width,  $title, $subtitle, $item_count, $pakghor_woo_excerpt_limit, $single_page_link, $show_rating, $category_options, $category, $tag, $postid, $offset, $order, $orderby, $section_bg, $bg_size, $bg_repeat, $bg_position, $section_overlay, $fc_class);
		return ob_get_clean();
	}
}
// Taxonomy query for this post type
if( ! function_exists('pakghor_product_three_taxonomy') ) {
    function pakghor_product_three_taxonomy() {
...
if( ! function_exists('pakghor_product_three_category') ) {
    function pakghor_product_three_category($taxonomy){
        global $wpdb;
...
$terms = pakghor_product_three_category('product_cat');
$data = array(
...
vc_map( array(
	"name"			=> esc_html__( "Pakghor Product Style Three", "pakghor" ),
	"base"			=> "pakghor_product_three",
	"class"			=> "",
    "icon"          => "fa fa-cutlery",
	...
	"params"		=> array(
        ...
        array(
            ...
            "admin_label"   => true,
            "description"   => esc_html__( 'How many Products want to display? Default is 9', 'pakghor' ),
            "group"			=> esc_html__( "General", "pakghor" ),
            "std"           => 9,
        ),
        array(
...
function pakghor_product_three( $section_top_icon, $section_top_image, $section_top_image_width,  $title, $subtitle, $item_count, $pakghor_woo_excerpt_limit, $single_page_link, $show_rating, $category_options, $category, $tag, $postid, $offset, $order, $orderby, $section_bg, $bg_size, $bg_repeat, $bg_position, $section_overlay, $fc_class ) {
    ...
    $wrapper_class = array('food-menu-item-wrapper', 'light') ;
...
?>
	...
	<!-- Food Products Stye three section-->
    		...
    		<div class="container">
                ...
                <?php endif; ?>
                    ...
                    if (class_exists('WooCommerce')) :
                        if( $category_options ) :
                        $fproduct_style_three_query = new WP_Query( array(
                                'post_type'             => 'product',
                        ...
                        if ( $fproduct_style_three_query->have_posts() ) :
                           
                            /* Start the Loop */
                            while ( $fproduct_style_three_query->have_posts() ) : $fproduct_style_three_query->the_post(); ?>
                                
                            <div class="col-md-4 col-sm-6">
                                <div class="food-item">
                                    <?php if( has_post_thumbnail() ) : ?>
                                    <div class="food-item-img">
                                        <?php the_post_thumbnail('pakghor-product-thumb-100-100'); ?>
                                    </div>
                                    <?php endif; ?>
