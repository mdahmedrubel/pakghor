...
class WPBakeryShortcode_pakghor_product_six extends WPBakeryShortcode {
	protected function content( $atts, $content = null ) {
		...
		ob_start();
			...
			pakghor_product_six( $section_top_icon, $section_top_image,  $section_top_image_width, $title, $subtitle, $item_count, $pakghor_woo_excerpt_limit, $single_page_link, $show_rating, $category_options, $category, $tag, $postid, $offset, $order, $orderby, $section_bgi, $bg_size, $bg_repeat, $bg_position, $section_overlay, $fc_class );
		return ob_get_clean();
	}
}

// Taxonomy query for this post type
if( ! function_exists('pakghor_product_six_taxonomy') ) {
    function pakghor_product_six_taxonomy() {
...
if( ! function_exists('pakghor_product_six_category') ) {
    function pakghor_product_six_category($taxonomy){
        global $wpdb;
...
$terms = pakghor_product_six_category('product_cat');
$data = array(
...
vc_map( array(
	"name"			=> esc_html__( "Pakghor Product Style Six", "pakghor" ),
	"base"			=> "pakghor_product_six",
	"class"			=> "",
    "icon"          => "fa fa-cutlery",
...
function pakghor_product_six( $section_top_icon, $section_top_image,  $section_top_image_width, $title, $subtitle, $item_count, $pakghor_woo_excerpt_limit, $single_page_link, $show_rating, $category_options, $category, $tag, $postid, $offset, $order, $orderby, $section_bgi, $bg_size, $bg_repeat, $bg_position, $section_overlay, $fc_class ) {
...
?>
	...
	<!-- Food Products Stye six section-->
    		...
    		<div class="container">
                ...
                <?php endif; ?>
                    ...
                    if (class_exists('WooCommerce')) :
                        if( $category_options ) :
                        $fproduct_style_six_query = new WP_Query( array(
                                'post_type'             => 'product',
                        ...
                        if ( $fproduct_style_six_query->have_posts() ) :
                            $i = 1;
                            /* Start the Loop */
                            while ( $fproduct_style_six_query->have_posts() ) : $fproduct_style_six_query->the_post(); ?>
                            <div class="col-md-4 col-sm-6">
                                <div class="food-item style-3">
                                    <div class="food-item-details">
                                        ...
                                        <p class="black"><?php echo wp_trim_words( get_the_content(), $pakghor_woo_excerpt_limit, '' ); ?></p>
                                        <?php 
                                            global $product;
