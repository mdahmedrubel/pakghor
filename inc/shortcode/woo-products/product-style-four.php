...
class WPBakeryShortcode_pakghor_product_four extends WPBakeryShortcode {
    protected function content( $atts, $content = null ) {
        ...
        ob_start();
            ...
            pakghor_product_four( $section_top_icon, $section_top_image,  $section_top_image_width, $title, $subtitle, $item_count, $pakghor_woo_excerpt_limit, $single_page_link, $show_add_cart, $show_rating, $category_options, $category, $tag, $postid, $offset, $order, $orderby, $section_bg, $bg_size, $bg_repeat, $bg_position, $section_overlay, $fc_class );
        return ob_get_clean();
    }
}
...
if( ! function_exists('pakghor_product_four_taxonomy') ) {
    function pakghor_product_four_taxonomy() {
...
if( ! function_exists('pakghor_product_four_category') ) {
    function pakghor_product_four_category($taxonomy){
        global $wpdb;
...
$terms = pakghor_product_four_category('product_cat');
$data = array(
...
vc_map( array(
    "name"          => esc_html__( "Pakghor Product Style Four", "pakghor" ),
    "base"          => "pakghor_product_four",
    "class"         => "",
    "icon"          => "fa fa-cutlery",
...
function pakghor_product_four( $section_top_icon, $section_top_image,  $section_top_image_width, $title, $subtitle, $item_count, $pakghor_woo_excerpt_limit, $single_page_link, $show_add_cart, $show_rating, $category_options, $category, $tag, $postid, $offset, $order, $orderby, $section_bg, $bg_size, $bg_repeat, $bg_position, $section_overlay, $fc_class ) {
    ...
    $sec_classes = array('lunch-menu', 'style-2');
    if( !empty($fc_class) ) {
            ...
            <div class="row">
               <?php 
                ...
                if (class_exists('WooCommerce')) :
                    if( $category_options ) :
                        $fproduct_style_four_query = new WP_Query( array(
                                'post_type'             => 'product',
                    ...
                    if ( $fproduct_style_four_query->have_posts() ) :
                        $i = 1;
                            /* Start the Loop */
                        while ( $fproduct_style_four_query->have_posts() ) : $fproduct_style_four_query->the_post(); ?>
                        <div class="col-md-3 col-sm-4">
                            <div class="food-item style-2">
                    ...
                    endwhile;  wp_reset_postdata();
                        ...
                        get_template_part( 'template-parts/content', 'nfour' );
