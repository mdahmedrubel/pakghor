<?php
/**
 * Pakghor Food Products Slider Shortcode
 *
...
class WPBakeryShortcode_pakghor_product_slider extends WPBakeryShortcode {
	protected function content( $atts, $content = null ) {
		...
		pakghor_product_slider( $section_top_icon, $section_top_image,  $section_top_image_width, $title, $subtitle, $item_count, $single_page_link, $show_rating, $product_slider_excerpt, $category_options, $category, $tag, $postid, $offset, $order, $orderby, $v_view_button_text, $v_view_button_url, $section_bg_image, $bg_size, $bg_repeat, $bg_position, $section_overlay, $fc_class );
		return ob_get_clean();
	}
}

// Taxonomy query for this post type
if( ! function_exists('pakghor_product_slider_taxonomy') ) {
    function pakghor_product_slider_taxonomy() {
...
if( ! function_exists('pakghor_product_slider_category') ) {
    function pakghor_product_slider_category($taxonomy){
        global $wpdb;
...
$terms = pakghor_product_slider_category('product_cat');
$data = array(
...
vc_map( array(
	"name"			=> esc_html__( "Pakghor Product Slider", "pakghor" ),
	"base"			=> "pakghor_product_slider",
	"class"			=> "",
    "icon"          => "fa fa-cutlery",
	...
	"params"		=> array(
        array(
            "type"			=> "iconpicker",
            "heading"		=> esc_html( "Product Slider Section Top Icon", "pakghor" ),
            "param_name"	=> "section_top_icon",
            "group"			=> esc_html__( "General", "pakghor" ),
        ),
        array(
            "type"			=> "attach_image",
            "heading"		=> esc_html( "Product Slider Top Image", "pakghor" ),
        ...
        array(
            "type"			=> "textfield",
            "heading"		=> esc_html__( "Product Slider Section Title", "pakghor" ),
            "param_name"	=> "title",
            "admin_label"   => true,
            "group"			=> esc_html__( "General", "pakghor" ),
        ),
        ...
        array(
            "type"			=> "textfield",
            "heading"		=> esc_html__( "Product Item Count", "pakghor" ),
        ...
        array(
            ...
            "param_name"    => "product_slider_excerpt",
            "admin_label"   => true,
            "description"   => esc_html__( 'The word lenth of short description of the product slider, Default is 20', 'pakghor' ),
            "group"         => esc_html__( "General", "pakghor" ),
            "std"           => 15,
        ),
        array(
        ...
        array(
            ...
            "admin_label"=> true,
            "value"     => array(
                esc_html__( "Select Product Order", "pakghor" )   => "",
        ...
        array(
            "type"          => "dropdown",
            "heading"       => esc_html__( "Product Order By", "pakghor" ),
            "group"         => esc_html__("Post Query", "pakghor"),
            "param_name"    => "orderby",
            "admin_label"   => true,
            "value"         => array(
                esc_html__( "Select Product order by","pakghor" ) => "",
...
function pakghor_product_slider( $section_top_icon, $section_top_image,  $section_top_image_width, $title, $subtitle, $item_count, $single_page_link, $show_rating, $product_slider_excerpt, $category_options, $category, $tag, $postid, $offset, $order, $orderby, $v_view_button_text, $v_view_button_url, $section_bg_image, $bg_size, $bg_repeat, $bg_position, $section_overlay, $fc_class ) {
	...
	<section <?php echo implode( ' ', $section_attr ); ?>>
        <div <?php echo implode( ' ', $overlay_attr ); ?>>
    		<div class="container custom-show">
                ...
                <?php endif; ?>
                    <div class="special-dishes-container">
                        <div <?php echo wp_kses_post( $swiper_wrapper_attr); ?>> 
    				<?php
                        if( $category_options ) :
                        $pakghor_product_slider = new WP_Query( array(
                                'post_type'             => 'product',
                        ...
                        if ( $pakghor_product_slider->have_posts() ) :

                            /* Start the Loop */
                            while ( $pakghor_product_slider->have_posts() ) : $pakghor_product_slider->the_post(); ?>
                                <div class="swiper-slide">
                                    <div class="dish-item">
                                        <?php if(has_post_thumbnail()) : ?>
                                        <div class="dish-img">
                                            <?php if( $single_page_link == true ) : ?>
                                            <a href="<?php the_permalink() ?>"><?php the_post_thumbnail('pakghor-product-slider-370-370'); ?></a>
                                            <?php else: ?>
                                           <?php the_post_thumbnail('pakghor-product-slider-370-370'); ?>
                                            <?php endif; ?>
                                        </div>
                                        <?php endif ?>
                                        <div class="dish-item-content">
                                            ...
                                            <p><?php echo wp_trim_words( get_the_content(), $product_slider_excerpt ); ?></p>
                                         <?php 
                                            global $product;
