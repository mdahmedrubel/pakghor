<?php
/**
 * Pakghor Food Gallery Shortcode
 *
...
class WPBakeryShortcode_pakghor_food_gallery extends WPBakeryShortcode {
...
if( ! function_exists('pakghor_gallery_taxonomy') ) {
...
if( ! function_exists('pakghor_gallery_category') ) {
    function pakghor_gallery_category($taxonomy){
        global $wpdb;
...
$terms = pakghor_gallery_category('gallery-category');
$data = array(
...
vc_map( array(
	"name"			=> esc_html__( "Pakghor Gallery", "pakghor" ),
	"base"			=> "pakghor_food_gallery",
	"class"			=> "",
    "icon"          => "fa fa-cutlery",
	...
	"params"		=> array(
        ...
        array(
            ...
            "description"   => esc_html__( "If you don't want to show Button leav blank", "pakghor" ),
            "group"			=> esc_html__( "General", "pakghor" ),
        ),
        array(
            "type"			=> "textfield",
...
function pakghor_food_gallery( $section_top_icon, $section_top_image,  $section_top_image_width, $title, $subtitle, $item_count, $is_gallery_menu, $category_options, $category, $tag, $postid, $offset, $order, $orderby, $view_button_text, $view_button_url, $section_bg_image_left, $lbg_size, $lbg_position, $section_bg_image_right, $rbg_size,  $rbg_position, $fc_class ) {
		...
		<div class="container">
			<div class="row">
				...
				<div <?php echo wp_kses_post($product_wrapper_attr); ?>>
                    ...
                    <?php $gallery_cats = get_terms( 'gallery-category', array(
                                'hide_empty'    => true,
                            ) );
                    if( $gallery_cats ) :
                         ?>
