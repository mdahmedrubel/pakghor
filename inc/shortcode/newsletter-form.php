<?php
/**
 * Pakghor Newsletter form Shortcode
 *
...
class WPBakeryShortcode_pakghor_newsletter_form extends WPBakeryShortcode {
	protected function content( $atts, $content = null ) {
		...
		ob_start();
			...
			pakghor_newsletter_form( $section_top_icon, $section_top_image, $section_top_image_width, $title, $subtitle, $newsletter_form_shortcode, $section_bg_image, $bg_size, $bg_repeat, $bg_position, $section_overlay, $fc_class );
...
vc_map( array(
	"name"			=> esc_html__( "Pakghor Newsletter Form", "pakghor" ),
	"base"			=> "pakghor_newsletter_form",
	"class"			=> "",
    "icon"          => "fa fa-cutlery",
	...
	"params"		=> array(
        ...
        array(
            "type"			=> "iconpicker",
            "heading"		=> esc_html__( "Newsletter Form Section Top Icon", "pakghor" ),
            "param_name"	=> "section_top_icon",
            "group"			=> esc_html__( "General", "pakghor" ),
        ),
        array(
            "type"			=> "attach_image",
            "heading"		=> esc_html__( "Newsletter Section Top Image", "pakghor" ),
        ...
        array(
            "type"			=> "textfield",
            "heading"		=> esc_html__( "Newsletter Section Title", "pakghor" ),
            "param_name"	=> "title",
            "group"			=> esc_html__( "General", "pakghor" ),
        ),
        array(
        ...
        array(
            "type"			=> "textfield",
            "heading"		=> esc_html__( "Newsletter Form (Mailpoet) Shortcode", "pakghor" ),
            "param_name"	=> "newsletter_form_shortcode",
            "group"			=> esc_html__( "General", "pakghor" ),
            "description"	=> esc_html__( "GIve here Mailpoet form Shortcode.", "pakghor" ),
        ),
        array(
            "type"			=> "attach_image",
...
function pakghor_newsletter_form( $section_top_icon, $section_top_image, $section_top_image_width, $title, $subtitle, $newsletter_form_shortcode, $section_bg_image, $bg_size, $bg_repeat, $bg_position, $section_overlay, $fc_class ) { 
    ...
    $form_wrapper_class = array('newslatter-input');
    $top_img_class = array();
